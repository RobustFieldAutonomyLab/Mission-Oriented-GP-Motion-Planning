...
bool Stomp::solve(const std::vector<double>& first,
                  const std::vector<double>& last,
                  Eigen::MatrixXd& parameters_optimized, double &total_cost)
{
  ...
  return solve(parameters_optimized_, parameters_optimized, total_cost);
}

bool Stomp::solve(const Eigen::VectorXd& first, const Eigen::VectorXd& last, Eigen::MatrixXd& parameters_optimized, double &total_cost)
{
  ...
  return solve(start, end, parameters_optimized, total_cost);
}

bool Stomp::solve(const Eigen::MatrixXd& initial_parameters, Eigen::MatrixXd& parameters_optimized, double &total_cost)
{
  ...
  total_cost = current_lowest_cost_;
