...
public:
   ...
   */
  bool solve(const std::vector<double>& first, const std::vector<double>& last, Eigen::MatrixXd& parameters_optimized, double &total_cost);
   ...
   * @return True if solution was found, otherwise false.
   */
  bool solve(const Eigen::VectorXd& first, const Eigen::VectorXd& last, Eigen::MatrixXd& parameters_optimized, double &total_cost);
   ...
   * @return True if solution was found, otherwise false.
   */
  bool solve(const Eigen::MatrixXd& initial_parameters, Eigen::MatrixXd& parameters_optimized, double &total_cost);
