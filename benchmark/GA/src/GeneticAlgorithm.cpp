...
GeneticAlgorithm::GeneticAlgorithm(const char * file_name, GAParameter params):
    generations_(params.generations_), popsize_(params.popsize_),
    c_(params.c_), path_length_(params.path_length_),
    cell_size_(params.cell_size_), origin_(params.origin_){
...
std::tuple<bool, std::vector<gtsam::Pose3>> GeneticAlgorithm::Plan(const gtsam::Pose3& start,
